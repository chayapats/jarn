...
Statuses: **Implemented** (in tree, or in a named draft PR for v1.1),
**Deferred** (explicitly out of scope). Do not leave an unmarked **Partial**.
Ops deploy notes: [TELEGRAM_GATEWAY.md](TELEGRAM_GATEWAY.md). Remaining CLI +
Telegram display SSOT:
[2026-08-15-hermes-parity-closeout.md](specs/2026-08-15-hermes-parity-closeout.md).

v1.1 rows below are Implemented on the stacked **draft** PRs. They are **not**
merged into `feat/hermes-parity-closeout` / main and are **not** a GitHub
Release.
