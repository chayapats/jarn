...
J.A.R.N. (v0.4.0, Alpha) is a local-first, permission-gated terminal agent harness built
...
| [CONTRIBUTING.md](CONTRIBUTING.md) | Contributors | Dev setup, CI gates (ruff · mypy · 1166 tests), testing layers, and how-to guides for common changes |
| [ROADMAP.md](ROADMAP.md) | Everyone | What is shipped (v0.4.0), what is planned, and known limitations |
