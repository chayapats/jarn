...
J.A.R.N. (v0.4.4, Alpha) is a local-first, permission-gated terminal agent harness built
...
| [ROADMAP.md](ROADMAP.md) | Everyone | What is shipped (v0.4.4), what is planned, and known limitations |
