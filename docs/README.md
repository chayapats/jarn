...
The current source line targets J.A.R.N. v1.0.8 General Availability; protected
...
| [ROADMAP.md](ROADMAP.md) | Everyone | what is in the v1.0.8 candidate, what is planned, and known limitations |
