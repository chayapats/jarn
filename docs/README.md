...
J.A.R.N. (v0.10.0, Alpha) is a local-first, permission-gated terminal agent harness built
...
| [CONTRIBUTING.md](CONTRIBUTING.md) | Contributors | Dev setup, CI gates (ruff · mypy · 2403 tests), testing layers, and how-to guides for common changes |
