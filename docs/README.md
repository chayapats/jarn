...
J.A.R.N. (v0.9.0, Alpha) is a local-first, permission-gated terminal agent harness built
...
| [ROADMAP.md](ROADMAP.md) | Everyone | What is shipped (v0.9.0), what is planned, and known limitations |
