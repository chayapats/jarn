...
Derived from [SPEC.md](../SPEC.md). Status as of **2026-07-02** (v0.5.0 released on PyPI + npm, Alpha).
...
- [x] `uv`/PyPI packaging, 1350 tests (+ packaging gate), clean lint + `mypy` CI
