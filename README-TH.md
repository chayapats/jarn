...
- **Ghost autosuggest:** ขณะพิมพ์ history entry ที่ตรงกันล่าสุดจะปรากฏเป็น ghost text สีหม่นหลัง cursor (แบบ fish/zsh) กด **→ (Right arrow)** หรือ **Ctrl+E** ที่ท้ายบรรทัดเพื่อยืนยัน suggestion เต็ม เมื่อ completion dropdown เปิดอยู่ dropdown มีความสำคัญกว่า; Right arrow ยังคงเลื่อน cursor กลางบรรทัดได้ปกติ
