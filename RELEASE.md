...
|------|------------------|-------|
| 1 | `uv tool install jarn` or `pip install jarn==0.1.0` | ☐ |
| 2 | `jarn --version` → `jarn 0.1.0` | ☐ |
...
- Open GitHub Release notes (copy from `CHANGELOG.md` §0.1.0)
