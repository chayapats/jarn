...
|------|------------------|-------|
| 1 | `uv tool install jarn` or `pip install jarn==0.6.0` (or `npm install -g jarn-cli`) | ☐ |
| 2 | `jarn --version` → `jarn 0.6.0` | ☐ |
